...
@endif
            <form action="{{ route('properties.index') }}" method="GET" class="form-search row g-2">
    
    <!-- Location -->
    <div class="col-md-4">
        <input type="text" name="location" class="form-control px-4" placeholder="City" value="{{ request('location') }}">
    </div>

    <!-- Min Price -->
    <div class="col-md-3">
        <input type="number" name="min_price" class="form-control px-4" placeholder="Min Price" value="{{ request('min_price') }}">
    </div>

    <!-- Max Price -->
    <div class="col-md-3">
        <input type="number" name="max_price" class="form-control px-4" placeholder="Max Price"  value="{{ request('max_price') }}">
    </div>
            ...
            <div class="property-slider-wrap">
              ...
              @foreach ($properties as $property)
                <div class="property-item">
                  ...
                  <a href="{{ route('show', $property->id) }}" class="img">
